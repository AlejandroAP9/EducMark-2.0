      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <header className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-4">
            Planificaciones de{' '}
            <span className="text-[#8B5CF6]">{shortName}</span>
          </h1>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            {grades.map((g) => (
              <Link
                ...
                className="group rounded-2xl border border-gray-200 bg-gray-50 p-6 hover:border-[#8B5CF6]/40 hover:shadow-md transition-all text-center"
              >
                <h3 className="font-bold text-gray-900 text-xl mb-2 group-hover:text-[#8B5CF6] transition-colors">
                  {g.grade}
                </h3>
                <p className="text-sm text-gray-500">{g.oaCount} objetivos de aprendizaje</p>
