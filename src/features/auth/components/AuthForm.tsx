                    ...
                    {mode === 'login' && (
                        <form onSubmit={handleLogin} className="auth-form active text-left">
                            <button
                                type="button"
                                onClick={handleGoogleAuth}
                                className="w-full flex items-center justify-center gap-3 px-4 py-3 mb-4 rounded-xl border border-[var(--border)] bg-[var(--input-bg)] hover:bg-[var(--card-hover)] transition-colors text-sm font-medium text-[var(--foreground)] cursor-pointer"
                            >
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <span className="text-[10px] text-[var(--muted)] uppercase tracking-wider">o con correo</span>
                                <div className="flex-1 h-px bg-[var(--border)]"></div>
                            </div>
