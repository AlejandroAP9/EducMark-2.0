  ...
  return (
    <div className="space-y-2">
      ...
      {indicators.map((ind) => (
        ...
        >
          <p className="text-xs font-medium text-[#06B6D4]">{ind.name}</p>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div>
            ...
            <div className="bg-white/[0.03] border border-white/10 rounded-xl p-4 max-h-60 overflow-y-auto">
          ...
          <div>
            ...
            <textarea
              ...
              rows={10}
              className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-[#F8F9FA] placeholder:text-white/20 focus:outline-none focus:border-[#8B5CF6] transition-colors resize-y font-mono leading-relaxed"
            />
          </div>
          ...
          <button
            onClick={handleCopy}
            className="w-full bg-gradient-to-r from-[#8B5CF6] to-[#06B6D4] hover:opacity-90 text-white font-semibold py-3 px-6 rounded-xl transition-all flex items-center justify-center gap-2"
          >
            <svg
              className="w-4 h-4"
              fill="none"
