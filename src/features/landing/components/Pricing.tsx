...
const plans: PricingPlan[] = [
  {
    ...
    priceAnnually: '$0',
    features: [
      { text: '3 kits completos (plan + PPT + quiz, 1 por kit)', included: true },
      { text: '27 Imagenes IA incluidas', included: true },
      { text: 'Borradores Portafolio Carrera Docente', included: true },
  ...
  },
  {
    ...
    features: [
      { text: '20 kits completos (plan + PPT + quiz)', included: true },
  ...
  },
  {
    ...
    recommended: true,
    features: [
      { text: '35 kits completos (plan + PPT + quiz)', included: true },
      { text: '35 Evaluaciones + Lector OMR', included: true },
      { text: 'Pauta de correccion con nivel Bloom', included: true },
      { text: 'Borradores Portafolio Carrera Docente', included: true },
  ...
  },
  {
    ...
    features: [
      { text: '50 kits completos (plan + PPT + quiz)', included: true },
      { text: '50 Evaluaciones + Retroalimentacion Pedagogica', included: true },
      { text: 'Pauta de correccion con nivel Bloom', included: true },
      { text: 'Borradores Portafolio Carrera Docente (ilimitados)', included: true },
